                    ...
                    <div className="collapse navbar-collapse fw-bold" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <Link style={{ fontSize: "20px" }} className="nav-link active text-light" aria-current="page" to="/" onClick={() => props.searchNews("")}>All</Link>
                            </li>
                            <li className="nav-item">
                                <Link style={{ fontSize: "20px" }} className="nav-link text-light" to="/politics" onClick={() => props.searchNews("")}>Politics</Link>
                            </li>
                            <li className="nav-item">
                                <Link style={{ fontSize: "20px" }} className="nav-link text-light" to="/technology" onClick={() => props.searchNews("")}>Technology</Link>
                            </li>
                            <li className="nav-item">
                                <Link style={{ fontSize: "20px" }} className="nav-link text-light" to="/cricket" onClick={() => props.searchNews("")}>Cricket</Link>
                            </li>
                            <li className="nav-item">
                                <Link style={{ fontSize: "20px" }} className="nav-link text-light" to="/science" onClick={() => props.searchNews("")}>Science</Link>
                            </li>
                            <li className="nav-item dropdown text-light">
                                ...
                                <ul className="dropdown-menu ">
                                    ...
                                    <li><Link className="dropdown-item" onClick={() => props.searchNews("")} to="covid">Covid-19 </Link></li>
                                    ...
                                    <li><Link className="dropdown-item" onClick={() => props.searchNews("")} to="/football">Football </Link></li>
                            ...
                            <li className="nav-item dropdown text-light">
                                ...
                                <ul className="dropdown-menu ">
                                    ...
                                    <li><button className="dropdown-item" onClick={() => props.changePageSize(48)}>48</button></li>
                                    <li><button className="dropdown-item" onClick={() => props.changePageSize(96)}>96</button></li>
                                </ul>
                            </li>
                        </ul>
                        <form className="d-flex w-100" role="search" onSubmit={postData}>
                            <input className="form-control me-2 text-dark" type="search" id='search' name='search' placeholder="Enter Something to Search" onChange={getData} aria-label="Search" />
